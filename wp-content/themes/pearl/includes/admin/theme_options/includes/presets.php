                ...
                'main_header' => array(
                    ...
                    'options' => array(
                        ...
                        'sticky-logo' => array(
                            'type' => 'image',
                            'data' => array(
                                'title' => esc_html__('Sticky Logo', 'pearl'),
                                'value' => '',
                                'description' => esc_html__('Sticky navbar Logo', 'pearl'),
                                'i18n' => array(
                                    'add' => esc_html__('Add image', 'pearl'),
                                    'remove' => esc_html__('Remove image', 'pearl'),
                                    'replace' => esc_html__('Replace image', 'pearl')
                    ...
                    'options' => array(
                        ...
                        'post_show_share' => array(
                            ...
                            'data' => array(
                                ...
                                'choices' => array(
                                    'show' => esc_html__('Show', 'pearl'),
                                    'hide' => esc_html__('Hide', 'pearl')
                                )
                            )
                        ),
                        'facebook' => array(
                            'type' => 'switch',
                            'show' => 'post_show_share',
                            'show_value' => 'hide',
                            'equal' => 'show',
                            'data' => array(
                                'title' => esc_html__('Facebook', 'pearl'),
                                'value' => true,
                            )
                        ),
                        'twitter' => array(
                            ...
                            'equal' => 'show',
                            'data' => array(
                                'title' => esc_html__('Twitter', 'pearl'),
                                'value' => true,
                            )
                        ),
                        'linkedin' => array(
                            ...
                            'equal' => 'show',
                            'data' => array(
                                'title' => esc_html__('Linkedin', 'pearl'),
                                'value' => true,
                            )
                        ),
                        'pinterest' => array(
                            ...
                            'equal' => 'show',
                            'data' => array(
                                'title' => esc_html__('Pinterest', 'pearl'),
                                'value' => true,
                            )
                        ),
                        'tumblr' => array(
                        ...
                        'whatsapp' => array(
                            ...
                            'equal' => 'show',
                            'data' => array(
                                'title' => esc_html__('Whatsapp', 'pearl'),
                                'value' => false,
                            )
                        ),
                        'telegram' => array(
                            ...
                            'equal' => 'show',
                            'data' => array(
                                'title' => esc_html__('Telegram', 'pearl'),
                                'value' => false,
                            )
                        ),
                        'skype' => array(

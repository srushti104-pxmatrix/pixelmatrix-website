...
function pearl_gallery_VC()
{
    ...
    vc_map(array(
        ...
        'params'      => array(
            ...
            array(
                'type'       => 'dropdown',
                'heading'    => esc_html__('Flip Mode', 'pearl'),
                'param_name' => 'flip',
                'value'      => array(
                    esc_html__('Random', 'pearl') => 'random',
                    esc_html__('Horizontal', 'pearl')  => 'horizontal',
                    esc_html__('Vertical', 'pearl') => 'vertical',
                ),
                'std'        => 'random',
                'dependency' => array(
                    'element' => 'style',
...
if (class_exists('WPBakeryShortCode')) {
    ...
    class Pearl_Masonry_Gallery
    {
        ...
        function print_gallery()
        {
            ...
            $flip = (isset($this->atts['flip']) && !empty($this->atts['flip'])) ? $this->atts['flip'] : 'random';

...
if (!is_admin()) {
    ...
    function pearl_load_scripts_and_styles()
    {
        ...
        wp_enqueue_style('bootstrap-datepicker3', $theme_info['css_vendor'] . 'bootstrap-datepicker3.css', null, $theme_info['v']);
        ...
        wp_enqueue_script('bootstrap-datepicker', $theme_info['js'] . 'bootstrap-datepicker/bootstrap-datepicker.js', $jquery, $theme_info['v'], true);

        wp_enqueue_script('bootstrap-datepicker-' . get_locale(), $theme_info['js'] . 'bootstrap-datepicker/locales/bootstrap-datepicker.' . get_locale() . '.js', $jquery, $theme_info['v'], true);

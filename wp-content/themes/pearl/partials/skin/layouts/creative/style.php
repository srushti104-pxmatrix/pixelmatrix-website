...
.stm_layout_creative .stm_pricing-table-flip_style_2.stm_flipbox .stm_flipbox__back .inner .btn span {
    color: <?php echo wp_kses_post($main_color); ?> !important;
}
...
.stm_layout_creative .stm_pricing-table-flip_style_2.stm_flipbox .stm_flipbox__back .inner .btn:hover span {
    color: #ffffff !important;
}
